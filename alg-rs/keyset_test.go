...
func TestKeySet_GetPublicKey(t *testing.T) {
	...
	tests := []struct {
		...
		{"Normal", KeySet{public: &k, kid: "key_id"}, publickey.New([]byte{0x30, 0x20, 0x30, 0xd, 0x6, 0x9, 0x2a, 0x86, 0x48, 0x86, 0xf7, 0xd, 0x1, 0x1, 0x1, 0x5, 0x0, 0x3, 0xf, 0x0, 0x30, 0xc, 0x2, 0x5, 0x0, 0xd6, 0xc8, 0xbc, 0x87, 0x2, 0x3, 0x1, 0x0, 0x1}, "key_id")},
		{"Invalid key", KeySet{public: &e}, publickey.PublicKey{}},
